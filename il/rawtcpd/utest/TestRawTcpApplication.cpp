...
class TestRawTcpApplication : public CPPUNIT_NS::TestCase
{
    CPPUNIT_TEST_SUITE(TestRawTcpApplication);
...
const rlim_t TestRawTcpApplication::MAXIMUM_OPEN_FILE_HARD_LIMIT = (32 * 1024);

///////////////////////////////////////////////////////////////////////////////

void TestRawTcpApplication::setUp(void)
{
...
void TestRawTcpApplication::testOneServerManyClients(void)
{   
    IL_DAEMON_LIB_NS::ActiveScheduler scheduler;
    RawTcpApplication::handleList_t serverHandles;
    RawTcpApplication::handleList_t clientHandles;
	RawTcpApplication app(1);
...

    {
        ...
        IL_DAEMON_LIB_MAKE_SYNC_REQUEST(req, void, &RawTcpApplication::Activate, &app, appReactor, boost::cref(ioReactorVec), boost::cref(ioBarrierVec));
        scheduler.Enqueue(req);
        req->Wait();
    }
    
    // Configure server block
    RawTcpApplication::serverConfig_t serverConfig;

    serverConfig.Common.Profile.L4L7Profile.ProfileName = "TestRawTcpApplication";
    ...
    serverConfig.ProtocolConfig.L4L7ProtocolConfigServerBase.ServerName = "TestRawTcpApplication";
    serverConfig.ProtocolConfig.MaxSimultaneousClients = 0;
    serverConfig.ProtocolConfig.MaxRequestsPerClient = 0;

    {
        const RawTcpApplication::serverConfigList_t servers(1, serverConfig);
        
        IL_DAEMON_LIB_MAKE_SYNC_REQUEST(req, void, &RawTcpApplication::ConfigServers, &app, 0, boost::cref(servers), boost::ref(serverHandles));
        scheduler.Enqueue(req);
        req->Wait();
    }
    ...
    RawTcpApplication::clientConfig_t clientConfig;
    ...
    clientConfig.Common.Profile.L4L7Profile.ProfileName = "TestRawTcpApplication";
    ...
    clientConfig.ProtocolConfig.L4L7ProtocolConfigClientBase.ClientName = "TestRawTcpApplication";
    ...
    {
        const RawTcpApplication::clientConfigList_t clients(1, clientConfig);
        
        IL_DAEMON_LIB_MAKE_SYNC_REQUEST(req, void, &RawTcpApplication::ConfigClients, &app, 0, boost::cref(clients), boost::ref(clientHandles));
        scheduler.Enqueue(req);
        req->Wait();
    }
    ...
    for (size_t run = 0; run < 1; run++)
    {
        ...
        {
            RawTcpApplication::handleList_t handles;

            handles.push_back(serverHandles[0]);
            handles.push_back(clientHandles[0]);
        
            IL_DAEMON_LIB_MAKE_SYNC_REQUEST(req, void, &RawTcpApplication::StartProtocol, &app, 0, boost::cref(handles));
            scheduler.Enqueue(req);
            req->Wait();
        }
        ...
        // Stop the server and client blocks
        {
            ...
            IL_DAEMON_LIB_MAKE_SYNC_REQUEST(req, void, &RawTcpApplication::StopProtocol, &app, 0, boost::cref(handles));
            scheduler.Enqueue(req);
            req->Wait();
        }
    }
    ...
    {
        IL_DAEMON_LIB_MAKE_SYNC_REQUEST(req, void, &RawTcpApplication::Deactivate, &app);
        scheduler.Enqueue(req);
        req->Wait();
    }
...
void TestRawTcpApplication::testNoServerManyClients(void)
{
    IL_DAEMON_LIB_NS::ActiveScheduler scheduler;
    RawTcpApplication::handleList_t clientHandles;
	RawTcpApplication app(1);
...
void TestRawTcpApplication::testOneServerManyClientsWithSingleThread(void)
{
    IL_DAEMON_LIB_NS::ActiveScheduler scheduler;
    RawTcpApplication::handleList_t serverHandles;
    RawTcpApplication::handleList_t clientHandles;
...
void TestRawTcpApplication::testNoServerManyClientsWithSingleThread(void)
{
    IL_DAEMON_LIB_NS::ActiveScheduler scheduler;
    RawTcpApplication::handleList_t clientHandles;
	RawTcpApplication app(1);
...
void TestRawTcpApplication::testOneServerManyClientsWithSinusoid(void)
{
    IL_DAEMON_LIB_NS::ActiveScheduler scheduler;
    RawTcpApplication::handleList_t serverHandles;
    RawTcpApplication::handleList_t clientHandles;
...
void TestRawTcpApplication::testNoServerManyClientsWithSinusoid(void)
{
    IL_DAEMON_LIB_NS::ActiveScheduler scheduler;
    RawTcpApplication::handleList_t clientHandles;
	RawTcpApplication app(1);
...
CPPUNIT_TEST_SUITE_REGISTRATION(TestRawTcpApplication);
