/// @file
/// @brief Raw tcp Client Block header file 
///
...
#ifndef _RAWTCP_CLIENT_BLOCK_H_
#define _RAWTCP_CLIENT_BLOCK_H_
...
class RawTcpClientBlock : public L4L7_APP_NS::BandwidthLoadManager, boost::noncopyable
{
  public:
    /// Convenience typedefs
    typedef RawTcp_1_port_server::RawTcpClientConfig_t config_t;
    typedef RawTcpClientRawStats stats_t;
    typedef boost::function2<void, uint32_t, bool> loadProfileNotifier_t;
    
    RawTcpClientBlock(uint16_t port, const config_t& config, ACE_Reactor *appReactor, ACE_Reactor *ioReactor, ACE_Lock *ioBarrier);
    ~RawTcpClientBlock();
