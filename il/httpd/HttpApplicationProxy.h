/// @file
/// @brief HTTP Application Proxy header file
///
...
#ifndef _HTTP_APPLICATION_PROXY_H_
#define _HTTP_APPLICATION_PROXY_H_
...
class HttpMsgSetSrv_1;

class HttpApplicationProxy : public IL_DAEMON_LIB_NS::Application
{
  public:
    IL_APPLICATION_CTOR_DTOR(HttpApplicationProxy);
  ...
  public:
    ...
    boost::scoped_ptr<HttpApplication> mApp;                            ///< application object that we are proxying for
    boost::scoped_ptr<HttpMsgSetSrv_1> mMsgSet;                         ///< message set handlers
