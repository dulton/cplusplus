...
#ifndef _HTTP_SERVER_BLOCK_RAW_STATS_H_
#define _HTTP_SERVER_BLOCK_RAW_STATS_H_
...
class HttpServerRawStats : public L4L7_UTILS_NS::StatsTimerManager
{
  public:
    typedef ACE_Recursive_Thread_Mutex lock_t;

    HttpServerRawStats(uint32_t handle)
        : activeConnections(0),
          mHandle(handle)
    {
        ResetInternal();
...
#ifdef UNIT_TEST    
    HttpServerRawStats& operator=(const HttpServerRawStats& other)
    {
        ...
        txResponseCode200 = other.txResponseCode200;
        txResponseCode400 = other.txResponseCode400;
        txResponseCode404 = other.txResponseCode404;
        txResponseCode405 = other.txResponseCode405;
        mHandle = other.mHandle;
        return *this;
    }

    HttpServerRawStats(const HttpServerRawStats& other) { *this = other; }
#endif
    ...
    uint64_t txResponseCode400;
    uint64_t txResponseCode404;
    uint64_t txResponseCode405;
