///
/// @file
/// @brief This file contains the constants and macros specific to httpd logging
///
...
///
/// $File: //TestCenter/integration/content/traffic/l4l7/il/httpd/HttpdLog.h $
/// $Revision: #1 $
...
#ifndef _HTTPD_LOG_H_
#define _HTTPD_LOG_H_
