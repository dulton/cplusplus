/// @file
/// @brief HTTP Client Block header file 
///
...
#ifndef _HTTP_CLIENT_BLOCK_H_
#define _HTTP_CLIENT_BLOCK_H_
...
class ClientBlock // : public L4L7_APP_NS::BandwidthLoadManager, boost::noncopyable
{
  public:
	   typedef HttpClientRawStats stats_t;
	   typedef HttpVideoClientRawStats videoStats_t;
	   typedef boost::function2<void, uint32_t, bool> loadProfileNotifier_t;
	   typedef Http_1_port_server::HttpClientConfig_t config_t;

	   ClientBlock(const config_t& config ):mConfig(config){}
	   virtual uint32_t BllHandle(void) const = 0;
	   virtual uint32_t IfHandle(void) const = 0;
	   virtual void NotifyInterfaceDisabled(void)= 0;
	   virtual void NotifyInterfaceEnabled(void)= 0;
	   virtual void RegisterLoadProfileNotifier(loadProfileNotifier_t notifier) = 0;
	   virtual void UnregisterLoadProfileNotifier(void) = 0;
	   virtual void SetDynamicLoad(int32_t load) = 0;
	   virtual stats_t& Stats(void) = 0;
	   virtual videoStats_t& VideoStats(void) = 0;
	   virtual void Start(void) = 0;
           virtual void PreStop(void) = 0;
	   virtual void Stop(void) = 0;
	   virtual bool VideoEnabled(void)= 0;
	   virtual ~ClientBlock(){};
...
class HttpClientBlock : public ClientBlock, public L4L7_APP_NS::BandwidthLoadManager, boost::noncopyable
{
  public:
    ...
    HttpClientBlock(uint16_t port, const config_t& config, ACE_Reactor *appReactor, ACE_Reactor *ioReactor, ACE_Lock *ioBarrier);
    ~HttpClientBlock();
