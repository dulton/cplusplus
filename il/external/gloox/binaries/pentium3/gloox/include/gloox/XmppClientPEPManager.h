...
#ifndef _Xmpp_CLIENT_PEP_MANAGER_H_
#define _Xmpp_CLIENT_PEP_MANAGER_H_
...
namespace gloox
{
  ...
  namespace PubSub
  {
    ...
    class GLOOX_API PEPManager : public IqHandler
    {
      public:
         ...
         * @param jid Subscribed entity.
         * @param node Node ID of the node.
         * @param df New configuration. The DataForm will be owned and deleted by the PEPManager.
         ...
         * @param items One or more items to publish. The items will be owned and deleted by the PEPManager,
         * even in the error case (empty string returned).
         * @param options An optional DataForm containing publish options. The DataForm will be owned and deleted by the PEPManager.
         * @param handler The handler to handle the result.
         * @return The ID used in the request.
         *
        ...
        const std::string publishPEPItem( const std::string& node,
                                       ItemList& items,
                                       DataForm* options,
                                       ResultHandler* handler );
         ...
         * The DataForm will be owned and deleted by the PEPManager.
         * @param handler The handler to handle the result.
         * @return The ID used in the request.
         *
        ...
        //spirent added -ekim
        void removeIqTrack( const std::string& id );

        // reimplemented from IqHandler.
        virtual void handleIqID( const IQ& iq, int context );

        //spirent added - ekim
        typedef std::map < std::string, std::string > PEPHandlerTrackMap;
        PEPHandlerTrackMap m_PEPTrackMap;
        util::Mutex m_PEPtrackMapMutex;
