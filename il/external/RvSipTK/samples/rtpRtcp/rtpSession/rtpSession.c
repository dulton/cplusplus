...
RvUint32 receivedPackets  = 0;                           /* Stores counter of received RTP packets */
RvUint32 rtpTimestamp     = 12345;                       /* Stores RTP sending timestamp */
...
#endif
{
    ...
    rtpSession  = RvRtpOpenEx(&rtpReceivingAddress, 0, 0, "RTP sender 8273423");
    if (rtpSession == NULL)
    {
    ...
    if (rtcpSession != NULL)
    {
        ...
        /* RvRtcpSessionSetParam(rtcpSession, RVRTCP_PARAMS_RTPCLOCKRATE, 8000);  clock rate - needed for dynamic payload         types */
    }
