...
/* SPIRENT_BEGIN */
    ...
    {
        /**
         *  SIOCGIFCONF is currently NOT supported by the user space stack and will fail if called.
         *  Return the loopback address so the stack has some address it can use.
         */
        struct sockaddr_in *sa;
        memset(buff, 0, sizeof(buff));
        ifc.ifc_len = sizeof(*ifrp);
        ifrp = (struct ifreq*) ifc.ifc_req;
