...
#define RV_CRITICAL_BEGIN() RR_Critical_Begin(__FILE__,__FUNCTION__,__LINE__)
#define RV_CRITICAL_END() RR_Critical_End(__FILE__,__FUNCTION__,__LINE__)

#else

#define RV_CRITICAL_BEGIN() rtac_critical_begin()
#define RV_CRITICAL_END() rtac_critical_end()
...
//SPIRENT_BEGIN
#if defined(UPDATED_BY_SPIRENT_ABACUS)
#define RvLockGet(_l,_lg) ((_l) ? (*(_l) = RV_CRITICAL_BEGIN()) : (RV_CRITICAL_BEGIN()))
#define RvLockRelease(_l,_lg) ((_l) ? (*(_l) = RV_CRITICAL_END()) : (RV_CRITICAL_END()))
#else
