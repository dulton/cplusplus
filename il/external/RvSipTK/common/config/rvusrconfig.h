...
#define RV_EHD_SEARCH_ORDER RV_EHD_SEARCH_HOSTS_LAST
...
//SPIRENT_BEGIN
#if defined(UPDATED_BY_SPIRENT)&&!defined(UPDATED_BY_SPIRENT_ABACUS)
#define RV_SELECT_PREEMPTION_PIPE_SIZE 16384
#else
...
/* SPIRENT_BEGIN */
//taken from the RTP/SRTP distribution:
#if defined(UPDATED_BY_SPIRENT)
#undef  RV_SECURITY
