...
LEGAL_HOST_OS:= solaris win32 linux tru64 hpux unixware solarispc freebsd mac netbsd

# List of supported Compiler Tools
LEGAL_COMPILER_TOOLS:= gnu sun diab ghs ads msvc compaqc cadul hpuxc metrowerks icc

# List of supported Target OS's
LEGAL_TARGET_OS:= solaris vxworks psos win32 linux ose nucleus tru64 hpux unixware solarispc symbian mopi integrity freebsd mac netbsd
