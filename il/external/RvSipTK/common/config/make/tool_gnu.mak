...
LEGAL_COMPILER_OS := solaris vxworks linux unixware symbian freebsd mac netbsd

# Set legal values for COMPILER_TOOL_VERSION
LEGAL_COMPILER_TOOL_VERSION := cyg-2.7 2.9 3.0 3.2 3.3 3.4 4.1 4.2 4.3 4.4 4.5
...
COMPILER_TOOL_VERSION_LINE := RV_TOOL_GNU_4_3
endif
ifeq ($(COMPILER_TOOL_VERSION), 4.4)
COMPILER_TOOL_VERSION_LINE := RV_TOOL_GNU_4_4
endif
ifeq ($(COMPILER_TOOL_VERSION), 4.5)
COMPILER_TOOL_VERSION_LINE := RV_TOOL_GNU_4_5
endif
...
INCLUDE_FLAG := -I
C_DEBUGFLAG := -g
C_OPTFLAG := -O3 -frename-registers -finline-functions
COMPILE_ONLY_FLAG := -c
OBJ_EXTENSION := .o
...
#
MAKEDEPEND = set -e; $(CC) -P -M -c $(CFLAGS) $(CPP_SPECIFIC_FLAGS) $< | $(MAKECYGPATH) \
