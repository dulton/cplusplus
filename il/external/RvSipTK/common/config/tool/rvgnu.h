...
/* SPIRENT_BEGIN */
#if defined(UPDATED_BY_SPIRENT) && defined(WINNT_LINUX)
#define RV_SIGNED_LONGLONG_TYPE   signed __int64   
#define RV_UNSIGNED_LONGLONG_TYPE unsigned __int64
#else
...
#define RV_SIGNED_INT16_TYPE   int16_t
#define RV_UNSIGNED_INT16_TYPE uint16_t
#define RV_SIGNED_INT32_TYPE   int32_t
#define RV_UNSIGNED_INT32_TYPE uint32_t
#define RV_SIGNED_INT64_TYPE   int64_t
#define RV_UNSIGNED_INT64_TYPE uint64_t
