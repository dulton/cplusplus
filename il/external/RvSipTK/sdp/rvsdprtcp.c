                ...
                const char* addr)
{
    ...
    rtcp = rvSdpMediaDescrGetRtcp(descr);
    if (rtcp)
    {
        rvSdpRtcpSetPort(rtcp,port);
        rvSdpRtcpSetNetType(rtcp,netType);
        rvSdpRtcpSetAddressType(rtcp,addrType);
        rvSdpRtcpSetAddress(rtcp,addr);
    }
    else
    {
