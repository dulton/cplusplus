...
*/
    ...
    b->iBuffer = newB;
    b->iBufferSz = newSz;
    b->iBufferOffset = b->iTotalUsed = (RvInt32)(p - newB);
    return RV_TRUE;
}
        ...
        RvStringBuffer *b)
{
    ...
    l1 = (int)strlen(oldTxt) + 1;
    l2 = (int)strlen(newTxt) + 1;
