...
INCLUDE_FILES_LIST += $(PROJECT_PATH)/RV_DEF.h
INCLUDE_FILES_LIST += $(PROJECT_PATH)/SELI_API.h
INCLUDE_FILES_LIST += $(PROJECT_PATH)/THREADS_API.h
INCLUDE_FILES_LIST += $(PROJECT_PATH)/TIMER_API.h
