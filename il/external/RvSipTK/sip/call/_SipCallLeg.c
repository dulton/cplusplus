                                       ...
                                       OUT RLIST_ITEM_HANDLE  *phItem)
{
    ...
    if (pCallLeg->eState==RVSIP_CALL_LEG_STATE_TERMINATED)
    {
        RvLogError(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
            "SipCallLegSubsAddSubscription - call-leg 0x%p, subs 0x%p - call is in TERMINATED state",
            pCallLeg, hSubs));
        CallLegUnLockAPI(pCallLeg);
        return RV_ERROR_ILLEGAL_ACTION;
    }

    rv =  CallLegSubsAddSubscription(hCallLeg, hSubs, phItem);
                                                  ...
                                                  IN RLIST_ITEM_HANDLE    hItem)
{
   ...
   RvStatus rv;
    ...
    rv = CallLegLockAPI((CallLeg*)hCallLeg);
    if(rv != RV_OK)
    {
        return RV_ERROR_INVALID_HANDLE;
    }
    rv =  CallLegSubsRemoveSubscription(hCallLeg, hItem);

    CallLegUnLockAPI((CallLeg*)hCallLeg);
    return rv;
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hCallLeg)
    RV_UNUSED_ARG(hItem)
                                       ...
                                       OUT RvSipSubsHandle        *phSubs)
{
    ...
    /* Don't remove this Lock, because FindSubsInCallLegByMsg() on Subscription
    Layer, which calls this function, relies on this */
    rv = CallLegLockAPI((CallLeg*)hCallLeg);
    if(rv != RV_OK)
    {
        return RV_ERROR_INVALID_HANDLE;
    ...
    rv = CallLegSubsFindSubscription(hCallLeg, hEvent, eSubsType, phSubs);

    CallLegUnLockAPI((CallLeg*)hCallLeg);
    return rv;
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hCallLeg)
    RV_UNUSED_ARG(hEvent)
...
{
    return CallLegGetIsHidden((CallLeg *)hCallLeg);
}
...
RvBool RVCALLCONV SipCallLegIsImsProtected(RvSipCallLegHandle hCallLeg)
{
    ...
    {
        bImsProtected = RV_TRUE;
    }
    else
    {
        bImsProtected = RV_FALSE;
    }

	CallLegUnLockAPI(pCallLeg);
    return bImsProtected;
...
{
    return CallLegGetActiveReferSubs((CallLeg *)hCallLeg);
}
...
RvSipTranscHandle RVCALLCONV SipCallLegGetMsgRcvdTransaction(RvSipCallLegHandle hCallLeg)
{
	...
	hMsgRcvdTransc = pCallLeg->hMsgRcvdTransc;

	CallLegUnLockAPI(pCallLeg); /*unlock the call leg*/
    return hMsgRcvdTransc;
}
...
#ifdef RV_SIP_SUBS_ON
    CallLeg* pCallLeg = (CallLeg*)hCallLeg;
    return pCallLeg->bFirstReferExists;
#else /* #ifdef RV_SIP_SUBS_ON */
	RV_UNUSED_ARG(hCallLeg)
    return RV_FALSE;
#endif /* #ifdef RV_SIP_SUBS_ON */
...
{
    CallLeg* pCallLeg = (CallLeg*)hCallLeg;
    pCallLeg->tripleLock = pTripleLock;
}
...
{
#ifdef RV_SIP_SUBS_ON
    return CallLegSubsInsertCallToHash(hCallLeg, bCheckInHash);
#else /* #ifdef RV_SIP_SUBS_ON */
	RV_UNUSED_ARG(hCallLeg)
	RV_UNUSED_ARG(bCheckInHash)
...
{
#ifdef RV_SIP_SUBS_ON
    CallLegRemoveFromHash((CallLeg*)hCallLeg);
    return RV_OK;
#else /* #ifdef RV_SIP_SUBS_ON */
	RV_UNUSED_ARG(hCallLeg)
...
{
#ifdef RV_SIP_SUBS_ON
    return CallLegSubsIsSubsListEmpty(hCallLeg);
#else /* #ifdef RV_SIP_SUBS_ON */
	RV_UNUSED_ARG(hCallLeg)
...
{
#ifdef RV_SIP_SUBS_ON
    return CallLegSubsGetSubscription((CallLeg*)hCallLeg, location, hRelative, phSubs);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hCallLeg)
    RV_UNUSED_ARG(location)
    RV_UNUSED_ARG(hRelative)
    *phSubs = NULL;
...
***************************************************************************/
RvStatus RVCALLCONV SipCallLegGetCurrentReferState (IN  RvSipCallLegHandle      hCallLeg,
                                                    OUT RvSipCallLegReferState *peState)
{
#ifdef RV_SIP_SUBS_ON
    *peState = CallLegReferGetCurrentReferState(hCallLeg);
    return RV_OK;
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hCallLeg)
    *peState = RVSIP_CALL_LEG_REFER_STATE_REFER_UNDEFINED;
...
RvSipAppCallLegHandle RVCALLCONV SipCallLegGetAppHandle(
                                      IN RvSipCallLegHandle     hCallLeg)
{
    return ((CallLeg*)hCallLeg)->hAppCallLeg;
}
...
{
    CallLegTerminateIfPossible((CallLeg*)hCallLeg, eReason);
}
...
SipTripleLock* RVCALLCONV SipCallLegGetMutexHandle(
                                      IN RvSipCallLegHandle     hCallLeg)
{
    return ((CallLeg*)hCallLeg)->tripleLock;
}
...
{
    return CallLegCreateTransaction((CallLeg*)hCallLeg, bAddToTranscList, phTransc);
}
...
RvStatus RVCALLCONV SipCallLegSendRequest(
                            ...
                            IN RvChar*                    strMethod)
{
    return CallLegSendRequest((CallLeg*)hCallLeg,hTransc, eRequestMethod, strMethod);
}
...
{
    CallLegDestruct((CallLeg*)hCallLeg);
}
...
void RVCALLCONV SipCallLegSetRedirectContact(RvSipCallLegHandle hCallLeg)
{
    ...
    {
        /*Move the new destingation to the contact address so that it will
...
{
    return CallLegGetStateName(eState);
}
...
{
    return CallLegGetStateEnum(strState);
}
...
{
    return CallLegGetDirectionName(eDirection);
}
...
{
    return CallLegGetDirectionEnum(strDirection);
}
...
{
    return CallLegUpdateReplacesStatus((CallLeg*)hCallLeg, hMsg);
}
                                            ...
                                            IN SipTripleLock*     pReferSubsTriplelock)
{
    ...
    pCallLeg->hReferSubsGenerator = hReferSubsGenerator;
...
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hCallLeg)
    RV_UNUSED_ARG(hReferSubsGenerator)
    RV_UNUSED_ARG(pReferSubsTriplelock)
 ...
 *          The function does not(!) set the call-leg triple lock pointer, to
 *          point back to itself triple lock.
 * Return Value: RvStatus
 * ------------------------------------------------------------------------
 * Arguments:
 * Input: pCallLeg - The call-leg handle.
...
{
    return CallLegGenerateCallId((CallLeg*)hCallLeg);
}
...
{
#ifdef RV_SIP_SUBS_ON
    return CallLegReferSetReferredBy((CallLeg*)hCallLeg, hReferredByHeader);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hCallLeg)
...
{
    ((CallLeg*)hCallLeg)->hHeadersListToSetInInitialRequest = hHeadersList;
    return RV_OK;
}
...
{
#ifdef RV_SIP_SUBS_ON
    RvSipCallLegHandle hDialogCallLeg;
    CallLeg* pCallLeg;
    RV_UNUSED_ARG(hAppCallLeg)

    hDialogCallLeg = CallLegSubsGetDialogHandle(hSubs);
    if(hDialogCallLeg == NULL)
    {
        return;
    }
    pCallLeg = (CallLeg*)hDialogCallLeg;

    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsCreatedEv: call-leg 0x%p - new refer subs 0x%p was created",
        pCallLeg, hSubs));

    if(NULL == hCallLeg)
    {
        /* set bIsReferCallLeg to TRUE, this way call-leg will treat this call-leg
           as regular, even though it is a hidden call-leg */
        pCallLeg->bIsReferCallLeg = RV_TRUE;

        /* the subscription is not in a connected call-leg.
           need to call the CallLegCreatedEv */
        CallLegMgrNotifyCallLegCreated(pCallLeg->pMgr, (RvSipCallLegHandle)pCallLeg, hReferTransc);

    }
    *phAppSubs = (RvSipAppSubsHandle)hDialogCallLeg;
#else /* #ifdef RV_SIP_SUBS_ON */
	RV_UNUSED_ARG(hAppCallLeg)
	RV_UNUSED_ARG(hCallLeg)
	RV_UNUSED_ARG(hSubs)
	RV_UNUSED_ARG(hReferTransc)
    *phAppSubs = NULL;
#endif /* #ifdef RV_SIP_SUBS_ON */
    return;
}
...
{
#ifdef RV_SIP_SUBS_ON
    CallLeg* pCallLeg = (CallLeg*)hAppSubs;

    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsStateChangedEv: call-leg 0x%p - subs 0x%p changed state",
        pCallLeg, hSubs));

    CallLegReferSubsStateChangedEvHandler(pCallLeg,hSubs,eState,eReason);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
                                ...
                                OUT RvSipAppNotifyHandle *phAppNotification)
{
    ...
    pCallLeg = (CallLeg*)hAppSubs;

    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsNotifyCreatedEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotification));

    *phAppNotification = NULL;
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(hNotification)

    *phAppNotification = NULL;
#endif /* #ifdef RV_SIP_SUBS_ON */
#if (RV_LOGMASK == RV_LOGLEVEL_NONE)
	RV_UNUSED_ARGS((hNotification,hSubs));
#endif
}
                                   ...
                                   IN  RvSipMsgHandle     hNotifyMsg)
{
    ...
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsNotifyEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotification));

    CallLegReferSubsNotifyStateChangedEv(pCallLeg,hSubs,hNotification,
                           ...
                           IN  RvSipMsgHandle                   hResponseMsg)
{
    ...
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsReferNotifyReadyEv: call-leg 0x%p - subs 0x%p, responseCode=%d",
        pCallLeg, hSubs, responseCode));

    CallLegReferSubsNotifyReadyEv(pCallLeg,hSubs,eReason,responseCode,hResponseMsg);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(eReason)
                      ...
                      IN    RvBool                          bCredentialsSupported)
{
    ...
    RV_UNUSED_ARG(hNotification)
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsAuthCredentialsFoundEv: call-leg 0x%p - subs 0x%p ",
        pCallLeg, hSubs));

    CallLegCallbackAuthCredentialsFoundEv(NULL,
                                          (RvSipCallLegHandle)pCallLeg,
                                          hAuthorization,
                                          bCredentialsSupported);
#else /* #if defined(RV_SIP_SUBS_ON) || defined(RV_SIP_AUTH_ON) */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(hNotification)
    RV_UNUSED_ARG(hAuthorization)
    bCredentialsSupported = RV_TRUE;
#endif /* defined(RV_SIP_SUBS_ON) || defined(RV_SIP_AUTH_ON) */
#if (RV_LOGMASK == RV_LOGLEVEL_NONE)
	RV_UNUSED_ARG(hSubs);
#endif
}
                      ...
                      IN    RvBool             bAuthSucceed)
{
    ...
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsAuthCompletedEv: call-leg 0x%p - subs 0x%p . bAuthSucceed=%d",
        pCallLeg, hSubs, bAuthSucceed));

    CallLegCallbackAuthCompletedEv(NULL, (RvSipCallLegHandle)pCallLeg, bAuthSucceed);
#else /* #if defined(RV_SIP_SUBS_ON) || defined(RV_SIP_AUTH_ON) */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(hNotification)
 ...
 * ------------------------------------------------------------------------
 * General:  calls to SipAuthenticatorCheckValidityOfAuthList with authentication 
                      ...
                      OUT   RvBool*              pbValid)
{
    ...
    return SipAuthenticatorCheckValidityOfAuthList(
        pCallLeg->pMgr->hAuthMgr, pCallLeg->pAuthListInfo, pCallLeg->hListAuthObj, pbValid);
                                    ...
                                    IN    RvSipMsgHandle       hMsg)
{
    ...
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsMsgToSendEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotify));

#if (RV_LOGMASK == RV_LOGLEVEL_NONE)
	RV_UNUSED_ARGS((hSubs,hNotify));
#endif

    return CallLegCallbackMsgToSendEv((RvSipCallLegHandle)pCallLeg, hMsg);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
                                    ...
                                    IN  RvSipMsgHandle       hMsg)
{
    ...
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsMsgReceivedEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotify));

#if (RV_LOGMASK == RV_LOGLEVEL_NONE)
	RV_UNUSED_ARGS((hSubs,hNotify));
#endif
    return CallLegCallbackMsgReceivedEv((RvSipCallLegHandle)pCallLeg, hMsg);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(hNotify)
                                    ...
                                    OUT RvBool                 *bAddressResolved)
{
    ...
    RV_UNUSED_ARG(hAppNotify)
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsOtherURLAddressFoundEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotify));

    return CallLegReferSubsOtherURLAddressFoundEvHandler(pCallLeg, hSubs, hNotify,
                                hMsg, hAddress, hSipURLAddress, bAddressResolved);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(hNotify)
                      ...
                      IN  RvSipMsgHandle            hMsgToSend)
{
    ...
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsFinalDestResolvedEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotify));

#if (RV_LOGMASK == RV_LOGLEVEL_NONE)
	RV_UNUSED_ARGS((hSubs,hNotify));
#endif
    return CallLegCallbackFinalDestResolvedEv(pCallLeg, hTransc, hMsgToSend);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(hNotify)
 ...
 *          with wrappers. We notify that a new connection was created.
 * Return Value: RV_OK
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:     hSubs          - The sip stack subscription handle
...

{
    ...
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsNewConnInUseEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotify));

#if (RV_LOGMASK == RV_LOGLEVEL_NONE)
	RV_UNUSED_ARGS((hSubs,hNotify));
#endif
    return CallLegCallbackNewConnInUseEv(pCallLeg, hConn,bNewConnCreated);
#else /* #ifdef RV_SIP_SUBS_ON */
    RV_UNUSED_ARG(hSubs)
    RV_UNUSED_ARG(hAppSubs)
    RV_UNUSED_ARG(hNotify)
                      ...
                      OUT RvSipTransmitterMsgCompType *peNextMsgComp)
{
    ...
    RV_UNUSED_ARG(hAppNotify)
    RvLogDebug(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
        "SipCallLegReferSubsSigCompMsgNotRespondedEv: call-leg 0x%p - subs 0x%p notify 0x%p",
        pCallLeg, hSubs, hNotify));

#if (RV_LOGMASK == RV_LOGLEVEL_NONE)
	RV_UNUSED_ARGS((hSubs,hNotify));
#endif
    return CallLegCallbackSigCompMsgNotRespondedEv(
                                               pCallLeg,
                                               hTransc,
                                               hAppTransc,
                                               retransNo,
...
RvStatus SipCallLegGetCallStorageSize(IN  RvSipCallLegHandle hCallLeg,
                                      ...
                                      OUT RvInt32           *pLen)
{
    return CallLegGetCallStorageSize(hCallLeg,bStandAlone,pLen);
}
...
{
     return CallLegStoreCall(hCallLeg,bStandAlone,maxBuffLen,memBuff,pStoredLen);
}
...
{
    return CallLegRestoreCall(memBuff, buffLen, bStandAlone,RVSIP_CALL_LEG_H_A_RESTORE_MODE_UNDEFINED, (CallLeg *)hCallLeg);
}
...
{
    return CallLegForkingInitCallLeg((CallLegMgr*)hCallLegMgr,(CallLeg*)hCallLeg,
                        (CallLeg*)hOriginalCallLeg,hMsg,bSwitchToAndFromTags);
}
                                        ...
                                        IN RvBool             bForkingEnabled)
{
    ...
    pCallLeg->bForkingEnabled = bForkingEnabled;
    return RV_OK;
}
                                    ...
                                    IN RvBool               *pbForkingEnabled)
{
    ...
    *pbForkingEnabled = pCallLeg->bForkingEnabled;
    return RV_OK;
}
                                        ...
                                        IN RvBool             bForkingEnabled)
{
    ...
    if (RV_TRUE == pCallLeg->pMgr->bEnableSubsForking)
    {
        if (RV_FALSE == pCallLeg->bForkingEnabled  &&  RV_TRUE == bForkingEnabled)
        {
            RvLogWarning(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
                "SipCallLegSetSubsForkingEnabledFlag - Call-leg 0x%p - forking is enabled in order to allow Subscription forking",
                pCallLeg));
        }
        pCallLeg->bForkingEnabled = bForkingEnabled;
    }
                                    ...
                                    OUT RvSipCallLegHandle  *phOrigCallLeg)
{
    ...
    if(pCallLeg->bOriginalCall == RV_TRUE)
    {
        ...
        *phOrigCallLeg = hCallLeg;
    }
    else
    {
        if (pCallLeg->originalForkedCallUniqueIdentifier ==
            ((CallLeg*)(pCallLeg->hOriginalForkedCall))->callLegUniqueIdentifier)
        {
            *phOrigCallLeg = pCallLeg->hOriginalForkedCall;
        }
        else
        {
            *phOrigCallLeg = NULL;
            RvLogWarning(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
                "SipCallLegGetOriginalCallLeg - Call-leg 0x%p - Original Call-Leg 0x%p discrepancy",
                pCallLeg, pCallLeg->hOriginalForkedCall));
        }
    }
...
{
    CallLeg *pCallLeg = (CallLeg*)hCallLeg;
    memcpy(&pCallLeg->sctpParams, pParams, sizeof(RvSipTransportSctpMsgSendingParams));
}
...
{
    CallLeg *pCallLeg = (CallLeg*)hCallLeg;
    memcpy(pParams, &pCallLeg->sctpParams, sizeof(RvSipTransportSctpMsgSendingParams));
}
                                               ...
                                               OUT RvSipCallLegInviteHandle *phInviteObj)
{
    ...
    rv = CallLegInviteFindObjByCseq(pCallLeg, cseq, eDirection, (CallLegInvite**)phInviteObj);
	if (RV_OK != rv)
	{
		RvLogError(pCallLeg->pMgr->pLogSrc,(pCallLeg->pMgr->pLogSrc,
					"SipCallLegInviteFindObjByCseq - Call-leg 0x%p - Failed to get Invite object for cseq=%d",
					pCallLeg, cseq));
	}
										   ...
										   OUT RvSipTransmitterHandle   *phTrx)
{
	RvStatus       rv;
    CallLeg       *pCallLeg   = (CallLeg*)hCallLeg;
	CallLegInvite *pInviteObj = (CallLegInvite*)hInviteObj;
