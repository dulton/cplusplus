...
proc notebook:create {var base tabs} {
    ...
    foreach tab $tabs {
        ...
        # Create a tab header
        button $base.but$i -borderwidth 0 -relief flat -text $tabName -width 0 -padx 2 -pady 2 \
...
proc disableModule:create {} {
    ...
    button .disable.restart -text "RESTART" -pady 0 -width 8 -command {
            Window delete .disable
            focus .test
            test.Restart
        }
    button .disable.cancel -text "Cancel" -pady 0 -width 8 -command {
            global app tmp
    ...
    # SETTING GEOMETRY
    ###################
    grid rowconf .disable 4 -weight 1
    grid columnconf .disable 0 -weight 1

    grid .disable.restart -in .disable -column 2 -row 4 -padx 2 -pady 2
    grid .disable.cancel  -in .disable -column 1 -row 4 -padx 2 -pady 2
}
