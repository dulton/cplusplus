...
#define RPOOL_Construct(pageSize,maxNumOfPages,logHandle,allocEmptyPagess,name) RPOOL_Construct_trace(pageSize,maxNumOfPages,logHandle,allocEmptyPagess,name,__FILE__,__LINE__)
