#************************************************************************
#Filename   : rvofferanswer.mak
#Description: SIP Toolkit (add-on) library sub-makefile
#************************************************************************
...
INCLUDE_FILES_LIST += $(shell find $(PROJECT_PATH) -name RvOa\*.h)
