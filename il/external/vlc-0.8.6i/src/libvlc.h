 ...
 * $Id: //TestCenter/integration/content/traffic/l4l7/il/external/vlc-0.8.6i/src/libvlc.h#1 $
 *
...
#define IFNAME_TEXT N_("Output interface name")
#define IFNAME_LONGTEXT N_( \
    "Specify the output interface name. This overrides the routing table.")

#define TOS_TEXT N_("Type of service (TOS)")
#define TOS_LONGTEXT N_( \
    "Specify the IPv4 type of service (TOS).")

#define TCLASS_TEXT N_("Traffic class")
#define TCLASS_LONGTEXT N_( \
    "Specify the IPv6 traffic class.")
#endif
...
#ifdef SPIRENT_CHANGES
    add_string( "ifname", 0, NULL, IFNAME_TEXT, IFNAME_LONGTEXT, VLC_TRUE );
    add_integer( "tos", -1, NULL, TOS_TEXT, TOS_LONGTEXT, VLC_TRUE );
    add_integer( "tclass", -1, NULL, TCLASS_TEXT, TCLASS_LONGTEXT, VLC_TRUE );
#endif
