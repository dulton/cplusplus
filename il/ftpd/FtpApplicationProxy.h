/// @file
/// @brief FTP Application Proxy header file
///
...
#ifndef _FTP_APPLICATION_PROXY_H_
#define _FTP_APPLICATION_PROXY_H_
...
class FtpMsgSetSrv_1;

class FtpApplicationProxy : public IL_DAEMON_LIB_NS::Application
{
  public:
    IL_APPLICATION_CTOR_DTOR(FtpApplicationProxy);
    
  private:
    // Application hooks from L4L7_APP_NS::Application interface
  ...
  public:
    ...
    boost::scoped_ptr<FtpApplication> mApp;                             ///< application object that we are proxying for
    boost::scoped_ptr<FtpMsgSetSrv_1> mMsgSet;                          ///< message set handlers
