/// @file
/// @brief Dpg Application header file
///
...
#ifndef _DPG_APPLICATION_H_
#define _DPG_APPLICATION_H_
...
class DpgApplication : boost::noncopyable
{
  public:
    ...
    typedef DpgIf_1_port_server::DpgPlaylistConfig_t playlistConfig_t;
    typedef std::vector<playlistConfig_t> playlistConfigList_t;
    typedef DpgIf_1_port_server::DpgClientConfig_t clientConfig_t;
    ...
    typedef DpgIf_1_port_server::DynamicLoadPair_t loadPair_t;
    typedef std::vector<loadPair_t> loadPairList_t;
    
    DpgApplication(uint16_t ports);
    ~DpgApplication();
...
#ifdef UNIT_TEST
    void GetDpgClientStats(uint16_t port, const handleList_t& handles, std::vector<DpgClientRawStats>& stats) const;
    void GetDpgServerStats(uint16_t port, const handleList_t& handles, std::vector<DpgServerRawStats>& stats) const;
#endif
...
#ifdef UNIT_TEST
    friend class ::TestDpgApplication;
#endif    
};
